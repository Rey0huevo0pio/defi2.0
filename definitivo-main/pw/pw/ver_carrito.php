            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="ayuda_general.php">Contacto</a></li>
    ...
    <main class="container mt-4">
        ...
        <?php if (isset($carrito) && count($carrito) > 0): ?>
            <?php foreach ($carrito as $item): ?>
                <div class="cart-item" data-id-carrito="<?php echo $item['id_carrito']; ?>">
                    <?php 
                        ...
                        if ($imagenes): ?>
                            <img src="<?php echo htmlspecialchars($imagenes[0]); ?>" alt="<?php echo htmlspecialchars($item['nombre']); ?>" class="card-img-top">
                        <?php endif; ?>
            ...
            <div class="cart-total">
                <strong>Subtotal del Carrito:</strong> $<span id="subtotal-carrito"><?php echo number_format($total, 2); ?></span>
            </div>
            <div class="cart-actions">
                <a href="seleccionar_metodo_y_direccion.php" class="btn btn-primary mt-3">Proceder a la Compra</a>
            </div>
        <?php else: ?>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (data.success) {
                            ...
                            $('#subtotal-carrito').text('$' + totalCarrito);
                        } else {
