                ...
                <?php foreach ($productos as $producto): ?>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 product">
                            ...
                            if ($imagenes): ?>
                                <img src="<?php echo htmlspecialchars($imagenes[0]); ?>" alt="<?php echo htmlspecialchars($producto['nombre']); ?>" class="card-img-top">
                            <?php endif; ?>
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    <a href="edit_product.php?id_producto=<?php echo $producto['id_producto']; ?>" class="btn btn-primary btn-sm">Editar</a>
