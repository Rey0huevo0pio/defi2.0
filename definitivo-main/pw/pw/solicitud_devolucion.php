...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $uniqueDir = 'fotos_devoluciones/' . uniqid('solicitud_', true);
    ...
    $stmt = $conn->prepare("INSERT INTO solicitudes_devolucion (id_pedido, id_usuario, motivo, ruta_fotos, estado) VALUES (?, ?, ?, ?, 'pendiente')");
    if ($stmt === false) {
    ...
    if ($stmt->execute()) {
        $_SESSION['success'] = "Solicitud de devolución enviada correctamente.";
    } else {
